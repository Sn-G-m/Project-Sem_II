...
DEFAULT_DETECTOR = (r"C:\Users\DELL\AppData\Local\Programs\Python\Python311"
                    r"\SemIIProject\Sample2\drive-download_new"
...
face_detector = cv2.dnn.readNetFromCaffe(proto_file_path, model_path)
...
embedding_model = cv2.dnn.readNetFromTorch(emb_model_path)
...
for (serial_no, location) in enumerate(img_path):
    ...
    img_tensor = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 1.0,
